...
function mapEventToStage(eventNumber, choiceSelections) {
    ...
    console.warn(`Could not map event ${eventNumber} to a stage`);
    return eventNumber; // Use event number as fallback
}
...
function displayPersonalityTimeline() {
    ...
    const choiceSelections = userData.choiceSelections || {};
